...
depth = -1
days = 5.5
#starttime = datetime(2014,7,18,13,0,0,0,pytz.UTC)
starttime = None
for ID in drifter_ids:
    if bool(filename):
         print 'getting drifter data... from raw datafile'
         drifter = get_drifter(ID,filename)                                                # Retrive drifter data
    else:
         print 'getting drifter data... '
    ...
    endtime = starttime + timedelta(days=days) #JiM modification
